allcharacter = [{"Name": "Eula", "hp": 1000,"Element": "Cryo", "Waepon Type": "Claymore", "Waepon": "Waster Greatsword", "ATK": 50},
                {"Name": "Raiden Shogun", "hp": 1000, "Element": "Electro", "Waepon Type": "Polearm", "Waepon": "Beginner's Protector", "ATK": 40},
                {"Name": "Sangonomiya Kokomi", "hp": 1000, "Element": "Hydro", "Waepon Type": "Catalyst", "Waepon": "Apprentice's Notes", "ATK": 30},
                {"Name": "Jean", "hp": 1000, "Element": "Anemo", "Waepon Type": "Sword", "Waepon": "Dull Blade", "ATK": 20},
                {"Name": "Mona", "hp": 1000, "Element": "Hydro", "Waepon Type": "Catalyst", "Waepon": "Apprentice's Notes", "ATK": 30},
                {"Name": "Kaedahara Kazuha", "hp": 1000, "Element": "Anemo", "Waepon Type": "Sword", "Waepon": "Dull Blade", "ATK": 20},
                {"Name": "Kamisato Ayaka", "hp": 1000, "Element": "Cryo", "Waepon Type": "Sword", "Waepon": "Dull Blade", "ATK": 50},
                {"Name": "Keqing", "hp": 1000, "Element": "Electro", "Waepon Type": "Sword", "Waepon": "Dull Blade", "ATK": 40}]
...
def attackTartaglia(value):
    ...
    while Tartaglia > 0:
        ...
        data[id_hero]['hp'] -= TartagliaDmg
        if Tartaglia > 0:
            if data[id_hero]['hp'] < 0:
                print("charachter anda mati, maaf anda kembali ke main menu")
                serangBos(data)
            print('Tartaglia - HP : ', Tartaglia, '-', 'Elemental Reaction ', data[id_hero]['Element'], '\n')
            print('hp hero : ',data[id_hero]['hp'])
            darah = input("apakah anda ingin mengonsumsi potion ?")
            if (darah == 'y'):
                data[id_hero]['hp'] += 500
...
def attackRhoderiaRage(value):
    ...
    while Rage > 0:
        ...
        if Rage > 0:
            ...
            print("\nRage - HP: {}\n".format(Rage))
            print("Challange Success\n")
            print("selamat anda berhasil mengalahkan Rhoderia Rage")
            menuGame(data)
...
def attackAndrius(value):
    ...
    while Andrius > 0:
        ...
        if Andrius > 0:
            ...
            print("\nAndrius - HP: {}\n".format(Andrius))
            print("Challange Success\n")
            print("selamat anda berhasil mengalahkan Andrius")
            menuGame(data)
...
def attackAzdhana(value):
    ...
    while Azdhana > 0:
        ...
        if Azdhana > 0:
            ...
            print("\nAzdhana - HP: {}\n".format(Azdhana))
            print("Challange Success\n")
            print("selamat anda berhasil mengalahkan azdhana")
            menuGame(data)
...
def subHero(value):
    return value['Name'],value['hp'], value['Waepon'], value['ATK']
